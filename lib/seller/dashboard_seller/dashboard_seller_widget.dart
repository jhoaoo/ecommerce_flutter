...
class DashboardSellerWidget extends StatefulWidget {
  const DashboardSellerWidget({super.key});

  static String routeName = 'dashboard_seller';
  static String routePath = '/dashboardSeller';

  @override
  State<DashboardSellerWidget> createState() => _DashboardSellerWidgetState();
}
