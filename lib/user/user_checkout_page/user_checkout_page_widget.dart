                              ...
                              child: Row(
                                ...
                                children: [
                                  Theme(
                                    ...
                                    child: Checkbox(
                                      value: _model.stripeValue ??= false,
                                      onChanged: (newValue) async {
                                        safeSetState(() =>
                                            _model.stripeValue = newValue!);
                                      },
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Theme(
                                      ...
                                      child: Checkbox(
                                        value: _model.yapeValue ??= false,
                                        onChanged: (newValue) async {
                                          safeSetState(() =>
                                              _model.yapeValue = newValue!);
                                        },
                                        side: (FlutterFlowTheme.of(context)
                                                    .accent1 !=
                                                null)
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child: Container(
                                            ...
                                            child: Image.asset(
                                              'assets/images/yape-app-logo-png_seeklogo-399697.png',
                                              fit: BoxFit.cover,
                                            ),
                                          ),
                                        ),
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Theme(
                                      ...
                                      child: Checkbox(
                                        value: _model.mercadoPagoValue ??=
                                            false,
                                        onChanged: (newValue) async {
                                          safeSetState(() => _model
                                              .mercadoPagoValue = newValue!);
                                        },
                                        side: (FlutterFlowTheme.of(context)
                                                    .accent1 !=
                                                null)
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: Image.asset(
                                              'assets/images/Mercado-Pago-Logo-Vector.svg-1-1.png',
                                              fit: BoxFit.cover,
                                            ),
                                          ),
                                        ),
                                            ...
                                            for (int loop1Index = 0;
                                              ...
                                              final currentLoop1Item =
                                                  containerCartsRecordList
                                                      .map((e) => e)
                                                      .toList()[loop1Index];
                                              _model.addToCartsDT(CartDTStruct(
                                                quantity:
                                                    currentLoop1Item.quantity,
                                                productRef:
                                                    currentLoop1Item.productRef,
                                                image: currentLoop1Item.image,
                                                productName: currentLoop1Item
                                                    .productName,
                                          ...
                                          child: Container(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  'S/${functions.calculateTotalPriceFromList(containerCartsRecordList.map((e) => e.price).toList(), containerCartsRecordList.map((e) => e.quantity).toList()).toString()}',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                                      .override(
