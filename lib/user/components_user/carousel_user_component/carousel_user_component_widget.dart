...
class _CarouselUserComponentWidgetState
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.selectedCategory = CategoriesDTStruct(
        categoryName: 'electro',
        categoryRef: FFAppState().initialCategory,
      );
      safeSetState(() {});
                  ...
                  children:
                    ...
                    return Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          _model.selectedCategory = CategoriesDTStruct(
                            categoryName: rowCategoriesRecord.name,
                            categoryRef: rowCategoriesRecord.reference,
                          );
                          _model.updatePage(() {});
                        },
                        child: Container(
                          decoration: BoxDecoration(
                            color: rowCategoriesRecord.name ==
                                    valueOrDefault<String>(
                                      _model.selectedCategory?.categoryName,
                                      'electro',
                                    )
                                ? FlutterFlowTheme.of(context).primary
                                : Color(0x00000000),
