...
class UserDetailPageWidget extends StatefulWidget {
  ...
  static String routeName = 'user_detail_page';
  static String routePath = '/userDetailPage';
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Builder(
                              builder: (context) {
                                final dynamycOrder =
                                    widget!.orderDoc?.items?.toList() ?? [];

                                return Column(
                                  mainAxisSize: MainAxisSize.max,
                                  children: List.generate(dynamycOrder.length,
                                      (dynamycOrderIndex) {
                                    final dynamycOrderItem =
                                        dynamycOrder[dynamycOrderIndex];
                                    return Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          16.0, 12.0, 16.0, 12.0),
                                      child: Row(
                      ...
                      children: [
                        ...
                        TextSpan(
                          text: valueOrDefault<String>(
                            formatNumber(
                              functions.calculateTotalPriceFromList(
                                  widget!.orderDoc!.items
                                      .map((e) => e.price)
                                      .toList(),
                                  widget!.orderDoc!.items
                                      .map((e) => e.quantity)
