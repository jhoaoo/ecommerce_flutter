...
class _UserProfilePageWidgetState extends State<UserProfilePageWidget> {
  ...
  void initState() {
    ...
    _model.nameEditTextController ??= TextEditingController();
    _model.nameEditFocusNode ??= FocusNode();

    _model.numberEditTextController ??= TextEditingController();
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        children: [
                          ...
                          Align(
                            alignment: AlignmentDirectional(0.87, -1.32),
                            child: FlutterFlowIconButton(
                              borderRadius: 8.0,
                              buttonSize: 20.0,
                              icon: Icon(
                              ...
                              onPressed: () async {
                                ...
                                if (selectedMedia != null &&
                                  ...
                                  safeSetState(() => _model
                                      .isDataUploading_uploadDataZpv = true);
                                  ...
                                  try {
                                    ...
                                    _model.isDataUploading_uploadDataZpv =
                                        false;
                                  }
                                  if (selectedUploadedFiles.length ==
                                      ...
                                      downloadUrls.length ==
                                          selectedMedia.length) {
                                    safeSetState(() {
                                      _model.uploadedLocalFile_uploadDataZpv =
                                          selectedUploadedFiles.first;
                                      _model.uploadedFileUrl_uploadDataZpv =
                                          downloadUrls.first;
                                    });
                                  } else {
                                    safeSetState(() {});
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                width: double.infinity,
                                child: TextFormField(
                                  controller: _model.numberEditTextController,
                                  ...
                                  enableInteractiveSelection: true,
                                  validator: _model
                                      .numberEditTextControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.birthdateEditTextController,
                                  focusNode: _model.birthdateEditFocusNode,
                                  autofocus: false,
                                  enabled: true,
                                  obscureText: false,
                                  decoration: InputDecoration(
              ...
              FFButtonWidget(
                onPressed: () async {
                  await currentUserReference!.update(createUserRecordData(
                    displayName: '',
                    photoUrl: _model.uploadedFileUrl_uploadDataZpv,
                    phoneNumber: '',
                  ));
                },
                text: 'save changes',
