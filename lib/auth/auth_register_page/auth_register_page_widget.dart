...
class _AuthRegisterPageWidgetState extends State<AuthRegisterPageWidget> {
  ...
  void initState() {
    ...
    _model.emailTextController ??= TextEditingController(text: 'Email');
    _model.emailFocusNode ??= FocusNode();

    _model.nameCTextController ??= TextEditingController(text: 'Name');
                        ...
                        onPressed: () async {
                          ...
                          await showDialog(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                title: Text('Ya te hemos enviado el mensaje '),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
