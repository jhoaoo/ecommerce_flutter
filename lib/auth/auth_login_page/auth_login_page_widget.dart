...
class _AuthLoginPageWidgetState extends State<AuthLoginPageWidget> {
  ...
  void initState() {
    ...
    _model.emailLTextController ??= TextEditingController(text: 'email');
    _model.emailLFocusNode ??= FocusNode();

    _model.passwordLTextController ??= TextEditingController(text: 'Password');
                    ...
                    children: [
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          validator: _model.emailLTextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          autofocus: false,
                          enabled: true,
                          obscureText: !_model.passwordLVisibility,
                          decoration: InputDecoration(
                            isDense: true,
                            labelStyle: FlutterFlowTheme.of(context)
                                .labelMedium
                            ...
                            suffixIcon: InkWell(
                              onTap: () async {
                                safeSetState(() => _model.passwordLVisibility =
                          ...
                          cursorColor: FlutterFlowTheme.of(context).primaryText,
                          enableInteractiveSelection: true,
                          validator: _model.passwordLTextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                      InkWell(
                        ...
                        onTap: () async {
                          if (_model.emailLTextController.text.isEmpty) {
                          ...
                          await authManager.resetPassword(
                            email: _model.emailLTextController.text,
                            context: context,
                          );
                        },
                        child: Text(
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          ...
                          final user = await authManager.signInWithEmail(
                            context,
                            _model.emailLTextController.text,
                            _model.passwordLTextController.text,
                          );
                          if (user == null) {
                            return;
                          }
                          ...
                          if (currentUserEmailVerified) {
                            if (valueOrDefault<bool>(
                                    currentUserDocument?.userNew, false) ==
                                false) {
                              ...
                              context.pushNamedAuth(
                                  AuthRegisterPageWidget.routeName,
                                  context.mounted);
                              ...
                              builder: (context) {
                                return GestureDetector(
                                  ...
                                  child: Padding(
                                    ...
                                    child: AuthVerificationPageWidget(),
                                  ),
                                );
                              },
